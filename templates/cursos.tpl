    ...
    <div class="full-w ed-grid lg-grid-7 lg-py-2 s-relative z-normal">
      <div class="course-banner-cover lg-order-2 lg-cols-4 s-ratio-16-9 s-overflow-hidden false">
        <div class="img-container lg-radius-1 s-ratio-16-9 background black-400">
          <img
            src="{{ .Curso.Img }}"
            alt="{{ .Curso.Nombre }}" class="lg-radius-1 color white-color s-transition" loading="auto">
        </div>
      </div>
      <div class="s-py-3 s-px-2 lg-cols-3 lg-pxy-0">
        <nav class="breadcrumbs ed-grid blue-400 s-mb-05">
          <i class="breadcrumbs__line smaller">
            ...
            <a class="color" href="{{ .Curso.Slug }}">{{ .Curso.Titulo }}</a>
          </i>
        </nav>
        <h1 class="s-mb-1 s-cross-start s-nowrap">
          <span class="color white-color s-mr-1">
          <span class="hidden">Curso: </span>{{ .Curso.Nombre }}</span>
        </h1>
        <p class="color grey-500">{{ .Curso.Descripcion }}</p>
        <div class="ed-grid row-gap s-gap-1 full s-mb-3">
          ...
          <div class="small flex">
            <div class="grey-400 s-mr-05 s-cross-start nowrap">
              ...
              <span class="color s-whitespace-nowrap">Calificación: {{ .Curso.Promedio }}</span>
            </div>
        ...
        <div>
          <div class="s-mb-1 s-cross-center">
            <a target="" class="s-cursor-pointer button small banner-Curso-button blue-500 s-mr-1 s-weight-semibold">
            ...
            <div class="grey-color s-pt-2 m-pt-0">
              <div class="flex false">
                <a class="network-btn" Titulo="Compartir en facebook" rel="noopener noreferrer"
                ...
                <a class="network-btn" Titulo="Compartir en twitter" rel="noopener noreferrer"
                ...
                <a class="network-btn" Titulo="Compartir en linkedin" rel="noopener noreferrer"
                ...
                <a class="network-btn" Titulo="Compartir en whatsapp" rel="noopener noreferrer"
                ...
                <a href="#" Titulo="Copiar enlace al portapapeles" class="jsx-1046511311 network-btn">
          ...
          <div class="s-main-start s-cross-center">
            <a target="" class="s-cursor-pointer  small color yellow-400 s-mr-2">
              <span class="s-cross-center s-main-center nowrap">
                ...
                <span class="">Compra este curso por <span>$</span>&nbsp;<span>{{ .Curso.Precio }}</span><span>USD</span></span>
              </span>
            </a>
          </div>
        </div>
  ...
  <div class="ed-grid">
    <section class="l-section">
      <div class="ed-grid m-grid-2 s-mb-2 s-px-2 lg-px-0">
        ...
        <div class="search-input form__item "><input type="search" Nombre="search"
          ...
          <article class="article s-mb-0 s-border-bottom">
            <div class="s-pt-2 m-pt-3 s-px-2 s-px-3 s-pb-2 s-cursor-pointer">
              <div class="s-cross-center nowrap">
                <h3 class="Curso-class__temary-Titulo s-mb-05 s-mr-1">{{ $modulo.Titulo }}</h3>
              </div>
              <p class="small color grey-500 s-mb-0">{{ $modulo.Descripcion }}</p>
            </div>
            <ul class="s-mb-0 ed-grid row-gap s-gap-1 s-overflow-hidden s-transition s-px-2 m-px-3 s-pb-2">

            {{ range $j, $class := $modulo.Clases }}
              ...
              <li class="fragment flex nowrap s-pxy-1 s-radius s-transition s-cursor-pointer s-relative false">
                <div class="flex nowrap s-cross-baseline">
                  ...
                  <p class="s-mb-0 color text-color s-mr-2">{{ $clases.Titulo }}</p>
                </div>
                <time class="s-to-right color text-color">{{ $clases.Duracion }}</time>
              </li>
